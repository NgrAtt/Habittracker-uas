...
- **Google Fonts**: Tipografi "Poppins" yang modern dan mudah dibaca.
- **Shared Preferences**: Untuk pengaturan aplikasi dan fallback data pada web.
- **Local Notifications**: Sistem pengingat tugas yang andal.
...
- Pastikan Anda memiliki editor seperti VS Code atau Android Studio dengan plugin Flutter.

### Instalasi
1. Clone repositori ini:
   ```bash
   git clone https://github.com/masdafa/Habittrackeruas.git
   ```
